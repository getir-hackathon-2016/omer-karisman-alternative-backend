...
module.exports = function (app, config) {
    ...
    app.get(urlPrefix + '/dbs', function(req, res) {
        ...
        connection.connect(dbConnectionStr, function (err, db) {
            ...
            if (err) {
                ...
                res.status(500).json({ message: 'Server error 8' });
                return;
            }
            ...
            adminDb.listDatabases(function(err, dbs) {
                if (err) {
                    ...
                    res.status(500).json({ message: 'Server error 9' });
                    return;
                }
    ...
    app.get(urlPrefix + '/:db', function (req, res) {
        ...
        connection.connect(dbConnectionStr + '/' + req.params.db, function (err, db) {
            ...
            if (err) {
                logger.error('Db open error: ' + err.message);
                res.status(500).json({ message: 'Server error 10' + err.message });
                return;
            }
            ...
            db.collectionNames(function (err, collections) {
                if (err) {
                    ...
                    res.status(500).json({ message: 'Server error 11' + err.message});
                    return;
                }
    ...
    */
    app.get(urlPrefix + '/:db/:collection/:id?', function(req, res) { 
        ...
        connection.connect(dbConnectionStr + '/' + req.params.db, function (err, db) {
            ...
            if (err) {
                logger.error('Db open error: ' + err.message);
                res.status(500).json({ message: 'Server error 12' });
                return;
            }
            ...
            db.collection(req.params.collection, function(err, collection) {
                if (err) {
                    ...
                    res.status(500).json({ message: 'Server error 13' });
                    return;
                }
                ...
                collection.find(query, options, function(err, cursor) {
                    if (err) {
                        ...
                        res.status(500).json({ message: 'Server error 14' });
                        return;
                    }
                    ...
                    cursor.toArray(function(err, docs){
                        if (err) {
                            ...
                            res.status(500).json({ message: 'Server error 15' });
                            return;
                        } 
    ...
    app.post(urlPrefix + '/:db/:collection', function(req, res) {
        if(req.body) {
            connection.connect(dbConnectionStr + '/' + req.params.db, function (err, db) {
                ...
                if (err) {
                    logger.error('Db open error: ' + err.message);
                    res.status(500).json({ message: 'Server error 16' });
                    return;
                }
                ...
                db.collection(req.params.collection, function(err, collection) {
                    if (err) {
                        logger.error('Error getting collection ' + collection + ': ' + err.message);
                        res.status(500).json({ message: 'Server error 17' });
                        return;
                    }
                    ...
                    collection.insert(
                        ...
                        function(err, docs) {
                            if (err) {
                                ...
                                res.status(500).json({ message: 'Server error 18' + err.message});
                                return;
                            }
    ...
    */
    app.put(urlPrefix + '/:db/:collection/:id', function(req, res) {
        ...
        connection.connect(dbConnectionStr + '/' + req.params.db, function (err, db) {
            ...
            if (err) {
                logger.error('Db open error: ' + err.message);
                res.status(500).json({ message: 'Server error 19' });
                return;
            }
            ...
            db.collection(req.params.collection, function(err, collection) {
                if (err) {
                    logger.error('Error getting collection ' + collection + ': ' + err.message);
                    res.status(500).json({ message: 'Server error 20' });
                    return;
                }
    ...
    */
    app.delete(urlPrefix + '/:db/:collection/:id', function(req, res) {
        ...
        connection.connect(dbConnectionStr + '/' + req.params.db, function (err, db) {
            ...
            if (err) {
                logger.error('Db open error: ' + err.message);
                res.status(500).json({ message: 'Server error 21' });
                return;
            }
            ...
            db.collection(req.params.collection, function(err, collection) {
                if (err) {
                    logger.error('Error getting collection ' + collection + ': ' + err.message);
                    res.status(500).json({ message: 'Server error 22' });
                    return;
                }
                ...
                collection.remove(spec, function(err, docs) {
                    if (err) {
                        ...
                        res.status(500).json({ message: 'Server error 23' });
                        return;
                    }
